...
export const Navbar = () => {
	async function vista() {
		await console.log("Emma Stone"), console.log("El Wizard");
	}
	return (
		<nav className="navbar navbar-dark " style={{ background: "#323336" }}>
			...
			<div className="form-group" style={{ display: "inline-flex" }}>
				<h4 onClick={vista} style={{ color: "white", fontSize: "20px", margin: "20px" }}>
					Inicio
				</h4>
				<h4 onClick={vista} style={{ color: "white", fontSize: "20px", margin: "20px", marginRight: "10px" }}>
					Servicios
				</h4>
				<h4 onClick={vista} style={{ color: "white", fontSize: "20px", margin: "20px", marginRight: "10px" }}>
					Acerca de{" "}
